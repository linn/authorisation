  ...
  /*  using System;
    ...
    public class CustomBoostrapper : AutofacNancyBootstrapper
    {
        ...
        protected override void ConfigureConventions(NancyConventions conventions)
        {
            ...
            conventions.StaticContentsConventions.Add(StaticContentConventionBuilder.AddDirectory("authorisation/assets", "client/assets"));
            conventions.StaticContentsConventions.Add(StaticContentConventionBuilder.AddDirectory("authorisation/build", "client/build"));
        }
