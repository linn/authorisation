namespace Linn.Authorisation.Domain.Tests.PermissionServiceTests
{
    ...
    public class WhenGettignAllPermissionsForPrivilegeAsValidUser : ContextBase
    {
        private Group group;
        ...
        public void SetUp()
        {
            this.privilege = new Privilege
                                 {
                                     Name = "do.hings", Id = 1, Active = true
                                 };
            ...
            this.PermissionRepository.FindAll().Returns(permissions.AsQueryable());
        ...
        {
            this.PermissionRepository.Received().FindAll();
        }
    }
}
